...
cmdBase = 'python /home/547/dg6911/git/agdc_mangrovemonitoring/CalcMangrovePVChange/Calc_AnnualFCPV_Tiles.py '
                  
outFileBase = '/g/data/r78/dg6911/MangPVChange_LeoSubset/'
cmds = []
for tile in range(len(gmwTiles)):
    ...
    cmd = cmd + ' --mangrove_ext ' + '/g/data/r78/dg6911/Extent/GMW_Australia_MangroveExtent2010_AlbersEA_shp.shp'
